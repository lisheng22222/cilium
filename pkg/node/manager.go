...
const (
	// BPFTunnel is the route type to set up the BPF tunnel maps
	BPFTunnel RouteType = 1 << iota
	// L3Route is the route type to set up the L3 route using iproute
	L3Route
)
...
// When using L3Route RouteType the field ownAddr should contain the IPv6
